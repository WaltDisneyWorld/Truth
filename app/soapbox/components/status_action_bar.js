...
import { IconButton, Menu, MenuButton, MenuList, MenuLink, Text, MenuDivider } from './ui';
...
class StatusActionBar extends ImmutablePureComponent {
  ...
  render() {
    const { status, intl, allowedEmoji, features } = this.props;
    ...
    return (
      <div className='pt-4 flex flex-row space-x-2'>
        ...
        <Menu title={intl.formatMessage(messages.more)}>
          {({ isExpanded }) => (
            <React.Fragment>
