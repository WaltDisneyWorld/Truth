...
const LinkFooter = ({ onOpenHotkeys, account, profileDirectory, federating, showAliases, importAPI, onClickLogOut, baseURL }) => (
  <div className='space-y-2'>
    <ul className='flex items-center divide-x-dot'>
      {account && <>
      ...
      <li><Link to='/legal' className='text-gray-400 hover:text-gray-500 hover:underline'><FormattedMessage id='navigation_bar.legal' defaultMessage='Legal' /></Link></li>
