...
import { Card, CardBody, HStack, Stack, Text } from '../../components/ui';
          ...
          <div className='px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center'>
            <div>
              <Stack space={3}>
                ...
                <Text size='lg'>
                  [redacted] is America&apos;s "Big Tent" social media platform that encourages an open,
          ...
          <div className='hidden lg:block sm:mt-24 lg:mt-0 lg:col-span-6'>
            <Card size='xl' variant='rounded' className='sm:max-w-md sm:w-full sm:mx-auto'>
              <CardBody>
                {isOpen ? (
                  <Stack space={3}>
                    <img src={require('icons/verified.svg')} className='h-16 w-16 mx-auto' alt='Verified' />
          ...
          <div className='lg:grid lg:grid-flow-row-dense lg:grid-cols-3 lg:gap-8 lg:items-start'>
            <div className='lg:col-span-1 lg:mt-24 order-1 lg:order-2'>
              <div className='space-y-3 text-left sm:text-center lg:text-left'>
                ...
                <Text size='lg'>
                  [redacted] is America&apos;s &quot;Big Tent&quot; social media platform that encourages an open, free, and honest global conversation without discriminating against political ideology.
                </Text>
              </div>
            </div>
